...
<head>
  ...
  <link href="./resources/css/home_styles.css?v=1" rel="stylesheet" type="text/css" >
    ...
    <main>
      ...
      <!--This section contains the three primary subjects listed as cards -->
        ...
        <div class="card">
          ...
          <a href="./Store.php#computing"><img class="card-img" src="../resources/images/Home_Page_Images/coding_card.jpg" alt="An image of code on a computer screen"/></a>
        </div>
        <div class="card">
          <h3 class="genre-heading">Business</h3>
          <a href="./Store.php#business"><img class="card-img" src="../resources/images/Home_Page_Images/business_card.jpg" alt="An image of two business people discussing documents"/></a>
        </div>
        <div class="card">
          <h3 class="genre-heading">Languages</h3>
          <a href="./Store.php#languages"><img class="card-img" src="../resources/images/Home_Page_Images/languages_card.jpg" alt="An image of a Spanish dictionary"/></a>
        </div>
      </section>
    </main>
